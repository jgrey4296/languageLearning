...
define(['lodash','./Parse'],function(_,Parse){
    ...
    let LanguageGen = {},
        grammar = {
            ...
            //Location
            locationName : "Temple of ${surName},Home of ${surName},${surName} shop,${surName} Factory,${rank} Palace,The ${surName} Bar,${surName} Market".split(/,/),
            //Char name
            charName : "${firstName.cap()} ${#0-2:middleName} ${surName}",
            firstName : "bob bill jill jim james".split(/ /),
            ...
            //attributes for strengths/weaknesses:
            attributes : "fire ice insults stealth food friendship loneliness".split(/ /),

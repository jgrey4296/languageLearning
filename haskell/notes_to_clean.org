...
-------------------- Links
http://www.haskell.org/onlinereport/haskell2010/haskellpa1.html#haskellch3.htlm
...
indentation is important across multiple lines
...
-- Here's a function that takes two arguments and returns the last
...
not -- a function that takes one value
==
/= -- not equal
< > <= >=
